...
#if QT_CONFIG(tooltip)
        self.mediaOpenBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Open Media Files", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.keyLabel.setToolTip(QCoreApplication.translate("MainWindow", u"Key Signature", None))
#endif // QT_CONFIG(tooltip)
        self.keyLabel.setText(QCoreApplication.translate("MainWindow", u"", None))
#if QT_CONFIG(tooltip)
        self.mediaPlayBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Play/Pause Opened Media", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.mediaPlayer.setToolTip(QCoreApplication.translate("MainWindow", u"Current Media Total Duration", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.currentPlayedLabel.setToolTip(QCoreApplication.translate("MainWindow", u"Current Played Time", None))
#endif // QT_CONFIG(tooltip)
        self.currentPlayedLabel.setText(QCoreApplication.translate("MainWindow", u"00:00", None))
#if QT_CONFIG(tooltip)
        self.mediaProgressSlider.setToolTip(QCoreApplication.translate("MainWindow", u"Seek Slider", None))
#endif // QT_CONFIG(tooltip)
        self.mediaDurationLabel.setText(QCoreApplication.translate("MainWindow", u"00:00", None))
#if QT_CONFIG(tooltip)
        self.mediaTitleLabel.setToolTip(QCoreApplication.translate("MainWindow", u"Current Media Label", None))
#endif // QT_CONFIG(tooltip)
        self.mediaTitleLabel.setText(QCoreApplication.translate("MainWindow", u"Select/Drop a Song!", None))
#if QT_CONFIG(tooltip)
        self.mediaMuteBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Mute/Unmute Button", None))
#endif // QT_CONFIG(tooltip)
        self.mediaMuteBtn.setText("")
#if QT_CONFIG(tooltip)
        self.volumeSlider.setValue(100)
        self.volumeSlider.setToolTip(QCoreApplication.translate("MainWindow", u"Volume Slider", None))
#endif // QT_CONFIG(tooltip)
        self.label.setText("")
...
#if QT_CONFIG(tooltip)
        self.authorLabel.setToolTip(QCoreApplication.translate("MainWindow", u"Author", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.resizeLabel.setToolTip(QCoreApplication.translate("MainWindow", u"Resize Application", None))
#endif // QT_CONFIG(tooltip)
